...
def snowman(snowman_word):
    ...
    while not is_word_guessed(snowman_word, correct_letter_guess_statuses) and len(wrong_guesses_list) < len(SNOWMAN_GRAPHIC): 
        ...
        print_snowman_graphic(len(wrong_guesses_list)) # should print regardless
        print_word_progress_string(snowman_word, correct_letter_guess_statuses)
        print_incorrect_letters(wrong_guesses_list)
...
def print_incorrect_letters(wrong_guesses_list):
    incorrect_guesses = ", ".join(wrong_guesses_list)
